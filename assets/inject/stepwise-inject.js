(() => {
  ...
  function toggleCodexTheme() {
    ...
    setCodexThemeMode(nextTheme)
      ...
      .catch((error) => {
        console.warn("[Mirror X Stepwise] Failed to switch Codex theme", error);
      });
  }
  ...
  function statusLine(settings) {
    if (settings.enabled !== true) return "Stepwise 已关闭，请在 Mirror X Codex 管理器里开启。";
  ...
  async function openManager() {
    state.settingsStatus = "正在打开 Mirror X Codex 管理器...";
    renderFloat();
