...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read mirror+ Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse mirror+ Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write mirror+ Zed remote project registry")]
