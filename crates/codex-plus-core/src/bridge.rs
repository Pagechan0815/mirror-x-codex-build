...
const BRIDGE_GENERATION_POLL_INTERVAL: Duration = Duration::from_millis(250);
...
/// Bridge sessions are versioned per injection target. A successfully installed
/// replacement becomes current only after all setup commands have completed.
