// English translations for the Mirror X Codex manager UI, keyed by the original
...
export const EN_PLAIN: Record<string, string> = {
  ...
  "Mirror X Codex 导入": "Mirror X Codex import",
  "Mirror X Codex 版本": "Mirror X Codex version",
  ...
  "Watcher 用于保持 Mirror X Codex 接管状态": "The watcher keeps Mirror X Codex in control",
  ...
  "保存到 Mirror X Codex state，不改写 Zed settings。": "Saved to Mirror X Codex state, does not modify Zed settings.",
  ...
  "关于": "About",
  "关于 Mirror X Codex": "About Mirror X Codex",
  "关闭": "Off",
  ...
  "卸载时移除 Mirror X Codex 托管数据": "Remove Mirror X Codex managed data on uninstall",
  ...
  "启动 Mirror X Codex": "Launch Mirror X Codex",
  "启动任务": "Launch task",
  ...
  "导入 Mirror X Codex 供应商": "Import Mirror X Codex provider",
  ...
  "已检测": "Detected",
  "已注册": "Registered",
  "已为 Mirror X Codex 预配置好接入参数。新建供应商时直接选择 Mirror X Codex 模板，只需填写 API Key 即可在 Codex 中使用本站可用模型。":
    "Mirror X Codex is preconfigured with the connection settings. Choose the Mirror X Codex template and only fill in the API Key to use the models available on the service.",
  ...
  "手动启动": "Manual launch",
  "打开": "Open",
  "打开 Mirror X Codex": "Open Mirror X Codex",
  "打开关于": "Open About",
  "打开链接": "Open link",
  "扩展项": "entry",
  "批量删除会话": "Bulk delete sessions",
  "把 Mirror X Codex 菜单插入 Codex 顶部原生菜单栏。": "Insert the Mirror X Codex menu into Codex's top native menu bar.",
  ...
  "使用 Mirror X Codex 内置快照补齐远端插件，API 模式也可显示和安装 Product Design 插件。":
    "Use the embedded Mirror X Codex snapshot to add remote plugins, so API mode can also show and install the Product Design plugin.",
  ...
  "未发现本地缓存；点击按钮会从 Mirror X Codex 内置快照释放并注册，无需官方账号预缓存。":
    "Local cache not found. Click the button to extract and register the embedded Mirror X Codex snapshot; no official-account pre-cache is required.",
  "未知": "Unknown",
  "未知作者": "Unknown author",
  "未知来源": "Unknown source",
  ...
  "检测到来自网页的供应商配置导入请求，确认后会写入本机 Mirror X Codex 管理器。":
    "A provider config import request from the web was detected; confirming writes it to this machine's Mirror X Codex manager.",
  "概览": "Overview",
  ...
  "正常": "OK",
  "此上游会通过本地 127.0.0.1:57321 转成 Responses API，需要从 Mirror X Codex 启动 Codex。":
    "This upstream is converted to the Responses API via local 127.0.0.1:57321, which requires launching Codex from Mirror X Codex.",
  ...
  "维护 Mirror X Codex 自己的远程项目最近列表。": "Maintain Mirror X Codex's own recent list of remote projects.",
  "编辑": "Edit",
  "编辑后保存列表，再切换模式时会使用新配置": "After editing, save the list; the new config is used the next time you switch modes",
  "编辑扩展项": "Edit entry",
  "缺失": "Missing",
  "缺少 Mirror X Codex 静默启动快捷方式时可在安装维护页修复。": "When the Mirror X Codex silent launch shortcut is missing, repair it on the Install & Maintenance page.",
  ...
  "配置文件": "Config file",
  "配置模型": "Config model",
  "重启 Mirror X Codex": "Restart Mirror X Codex",
  "重新安装": "Reinstall",
  "重新生成": "Regenerate",
  ...
  "Codex 配置状态不可读，请先恢复 config.toml / auth.json 后再切换供应商。":
    "Codex configuration state is unreadable. Restore config.toml / auth.json before switching providers.",
  "历史会话修复已跳过。": "Historical session repair was skipped.",
  "推荐接入": "Recommended connection",
  "本页会话": "Sessions on this page",
  "本页未归档": "Unarchived on this page",
  "本页已归档": "Archived on this page",
  "上一页": "Previous page",
  "下一页": "Next page",
  "默认推荐内容已禁用": "Default recommendations are disabled",
  "当前未提供推荐内容": "No recommendations are currently available",
  "已移除默认远端广告与赞助内容。": "The default remote ads and sponsored content have been removed.",
  "服务地址": "Service URL",
  "打开服务页面": "Open service page",
  "默认已禁用的推荐内容": "Recommendations disabled by default",
  "版本信息、GitHub Release 更新、日志与诊断": "Version info, GitHub Release updates, logs and diagnostics",
};
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "{0} 个": "{0}",
  "{0} 个 Mirror X Codex 可识别项目，默认策略：{1}": "{0} project(s) recognized by Mirror X Codex, default strategy: {1}",
  "{0} 个供应商": "{0} provider(s)",
  ...
  "第 {0} 页": "Page {0}",
  "第 {0} 页，每页最多 {1} 条，按更新时间倒序显示":
    "Page {0}; up to {1} items per page, sorted by most recently updated",
